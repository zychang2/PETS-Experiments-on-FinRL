...
# CACHE_ROOT = Path.home() / Path(".cache/finrl/")
CACHE_ROOT = Path(".")

DATA_SAVE_DIR = CACHE_ROOT / "datasets"
TRAINED_MODEL_DIR = CACHE_ROOT / "trained_models"
TENSORBOARD_LOG_DIR = CACHE_ROOT / "tensorboard_log"
