...
class StockTradingEnv(gym.Env):
    ...
    def __init__(
        ...
        mode="",
        iteration="",
    ): # Already been through many of these in a2c_model.py
        self.day = day
        self.df = df
        ...
        self.action_space = spaces.Box(low=-1, high=1, shape=(self.action_space,)) # Will be multiplied by 100 and converted to int to get actual action (buy, sell, hold)
